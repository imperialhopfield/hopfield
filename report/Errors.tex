...
network computes the probability of error of the superattractor. The caller
has to ensure that training patterns are independent in order for the
computation to be correct.

\tmtextbf{Deascresing the error by using one super attractor}
...
assumption that all other traning patterns are independent. We will now show
...
computes the probability of error of the superattractor. The caller of the

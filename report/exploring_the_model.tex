...
\subsubsection{Further explanation of the results using T1}

The results can also be easily understood and visualised in figure \ref{fig:basins}. For small p values, the attractors formed in the network are too close to each other to allow room for any basin sizes. When the p-value is high, the attractors become more disperse, leaving room for large basin sizes. %It is also worth mentioning that, as p 
